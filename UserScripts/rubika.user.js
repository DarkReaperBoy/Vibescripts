...
// ── Privacy: block time-per-chat tracking before encryption ──
const _origJSONStringify=JSON.stringify;
JSON.stringify=function(v){try{if(v&&typeof v==="object"&&v.method==="setChatUseTime")return _origJSONStringify({method:"getTime",input:{}});}catch(_){}return _origJSONStringify.apply(this,arguments);};
